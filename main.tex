...
\section*{Core Skills}
\textbf{Programming Languages:} Python, SQL, JavaScript, C, C++, CUDA, Bash, HTML5, CSS3, JSON, XML, YAML \\
\textbf{AI / Machine Learning:} Machine Learning, Deep Learning, Generative AI, Large Language Models (LLMs), Agentic AI, Agentic Flow, Token Optimization, Natural Language Processing (NLP), Retrieval-Augmented Generation (RAG), Transformers, BERT, LangChain, Knowledge Graphs, Neural Networks, Computer Vision, Reinforcement Learning, Predictive Analysis, Statistical Modeling, A/B Testing \\
\textbf{Machine Learning Frameworks:} PyTorch, TensorFlow, TensorFlow Lite, TensorFlow.js, Keras, scikit-learn, XGBoost, LightGBM, CatBoost, Hugging Face Transformers, OpenCV, ONNX Runtime, PySpark MLlib, Dask-ML \\
\textbf{Data Science / Analytics:} Pandas, NumPy, SciPy, CuPy, PySpark, Spark, Apache Spark, Databricks, Exploratory Data Analysis (EDA), Data Analytics, Data Visualization, Web Scraping, Selenium, GeoPandas, Rasterio, ArcGIS Pro, ArcPy, Remote Sensing, Spatial Data Modeling, Data Fusion, Signal Processing \\
\textbf{Visualization / BI:} Tableau, Power BI, Matplotlib, Seaborn, Plotly, ArcGIS Pro \\
\textbf{Cloud / DevOps / Systems:} Amazon Web Services (AWS), Serverless, EC2, S3, SNS, Amazon SQS, Lambda, ECS, EKS, SageMaker, Azure, Azure Databricks, Docker, Kubernetes, MLOps, LLMOps, MLflow, Linux, Ubuntu, Raspbian, Agile, Scrum \\
\textbf{Databases:} PostgreSQL, MySQL, Snowflake, MongoDB, Vector Databases, Knowledge Graphs, RDBMS, NoSQL \\
\textbf{Web / Application Development:} Node.js, React.js, Express.js, Flask, FastAPI, API Development, REST APIs, GraphQL APIs, SOAP APIs, OpenAPI, Microservices, Dialogflow \\
\textbf{Agentic AI Tools:} Amazon CodeWhisperer, Gemma, Claude Code, GitHub Copilot, Spec-Kit
